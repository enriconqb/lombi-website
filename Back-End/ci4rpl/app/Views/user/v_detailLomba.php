...
<section class="section">
        ...
        <div class="row">
            ...
            <div class="col-md-7 pt-5 pt-lg-0">
                <div class="about-content">
                    <h1 class="font-weight-bold">Puisi</h1>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <a href="<?php echo base_url('daftarlomba')?>" class="btn btn-primary font-weight-bold">Daftarkan dirimu sekarang</a>
                        </div>
                        <div class="col-sm-6">
    ...
    <div class="container py-3">
        <div>
            <div class="about-content">
                <h1 class="font-weight-bold">Tema</h1>
                <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc est justo, aliquam nec tempor fermentum, commodo et libero. Quisque et rutrum arcu. Vivamus dictum tincidunt magna id euismod. Nam sollicitudin mi quis orci lobortis feugiat. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc est justo, aliquam nec tempor fermentum, commodo et libero. Quisque et rutrum arcu. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc est justo, aliquam nec tempor fermentum, commodo et libero. Quisque et rutrum arcu. Vivamus dictum tincidunt magna id euismod. Nam sollicitudin mi quis orci lobortis feugiat.</p>
                <h1 class="font-weight-bold">Timeline</h1>
                <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc est justo, aliquam nec tempor fermentum, commodo et libero.</p>
                    ...
                    <div class="col-sm-4">
                        <div class="card" style="background-color:#D5E8F4; border-radius:20px;">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title">1-10 Maret 2022</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card" style="background-color:#D5E8F4; border-radius:20px;">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title">11-13 Maret 2022</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card" style="background-color:#D5E8F4; border-radius:20px;">
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title">20 Maret 2022</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row pb-3 justify-content-center">
                    <div class="col-sm-2">
                        <div class="card" style="background-color:#D5E8F4; border-radius:20px;">
                            <div class="card-body text-center">
                                <h5 class="card-title pt-3">1 Karya</h5>
                                <h5 class="card-title">1-10 Maret 2022</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="card" style="background-color:#D5E8F4; border-radius:20px;">
                            <div class="card-body text-center">
                                <h5 class="card-title pt-3">2 Karya</h5>
                                <h5 class="card-title">11-13 Maret 2022</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="card" style="background-color:#D5E8F4; border-radius:20px;">
                            <div class="card-body text-center">
                                <h5 class="card-title pt-3">3 Karya</h5>
                                <h5 class="card-title">20 Maret 2022</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="card" style="background-color:#D5E8F4; border-radius:20px;">
                            <div class="card-body text-center">
                                <h5 class="card-title pt-3">4 Karya</h5>
                                <h5 class="card-title">20 Maret 2022</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="card" style="background-color:#D5E8F4; border-radius:20px;">
                            <div class="card-body text-center">
                                <h5 class="card-title pt-3">5 Karya</h5>
                                <h5 class="card-title">20 Maret 2022</h5>
                            </div>
                        </div>
                    </div>
