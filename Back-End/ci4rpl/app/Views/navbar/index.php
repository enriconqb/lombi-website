		...
		<div class="row">
			<div class="col-md-12">
              ...
              if(session()->get('hak_akses') === 'super_admin'){?>
                <li class="nav-item">
                  <a class="nav-link text-white add-button" href="<?php echo base_url('admin')?>">Admin</a>
                </li>
              <?php
              }?>
              <?php 
              if(session()->get('log')){?>
                <li class="nav-item">
                  <a class="nav-link text-white add-button" href="<?php echo site_url('admin')?>">Lomba</a>
                </li>
                <li class="nav-item">
