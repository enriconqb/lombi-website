  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <!-- <div class="row mb-2"> -->
          <div class="col-sm-6">
            <h1 class="m-0"><b>Cek Pembayaran</b></h1>
      </div> <!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
  </div>
              ...
              <div class="card-login">
                <form action="" method="POST">
                    <table cellpadding="5">
                        ...
                        <tr>
                            <td width="200px"><label for="user">Jumlah Pembayaran        </label></td>
                            <td width="600px"><input type="text" class="form-control" name="user" placeholder="Rp. 150.000"></td>
                        </tr>
                        <tr>
                            <td width="200px"><label for="user">Bukti Pembayaran        </label></td>
                            <td><div style="border: 1px solid black; padding: 3px; border-radius: 1px; width: 160px; height: 30px; text-align: center;">Bukti Pembayaran</div></td>
                        </tr>
                    </table>      
                </form>
                <br>
                <div class="row justify-content-center">
                    <table cellpadding="5px">
                        <tr>
                            <td>
                                <div >
                                  <button class="btn btn-warning" type="belum" value="belum">Belum</button>
                                </div>
                            </td>
                            <td>
                                <div >
                                <button class="btn btn-danger" type="gagal" value="gagal">Gagal</button>
                                </div>
                            </td>
                            <td>
                                <div>
                                <button class="btn btn-success" type="valid" value="valid">Valid</button>
                                </div>
                            </td>
                        </tr>
                      </table>
