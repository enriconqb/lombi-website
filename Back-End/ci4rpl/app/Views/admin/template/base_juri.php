...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="" class="brand-link bg-danger text-center">
      <span class="brand-text font-weight-light "><b>Juri</b></span>
    </a>
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url('juri')?>" class="d-block">Data Penilaian</a>
        </div>
      </div>
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url('inputpenilaian')?>" class="d-block">Input Penilaian</a>
        </div>
      </div>
  </aside>
